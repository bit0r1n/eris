        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "CHANNEL_CREATE": {
                ...
                if(packet.d.guild_id) {
                    ...
                    if ([ChannelTypes.GUILD_NEWS_THREAD, ChannelTypes.GUILD_PUBLIC_THREAD, ChannelTypes.GUILD_PRIVATE_THREAD].includes(channel.type)) {
                        channel.parent = channel.guild.channels.get(channel.parentID);
                        if (channel.parent) {
                            channel.parent.threads.add(channel);
                        }
                    }
            ...
            case "CHANNEL_UPDATE": {
                ...
                if(oldType === packet.d.type) {
                    ...
                    if(packet.d.guild_id) {
                        ...
                        if ([ChannelTypes.GUILD_NEWS_THREAD, ChannelTypes.GUILD_PUBLIC_THREAD, ChannelTypes.GUILD_PRIVATE_THREAD].includes(newChannel.type)) {
                            newChannel.parent = guild.channels.get(newChannel.parentID);
                            if (newChannel.parent) {
                                newChannel.parent.threads.add(newChannel);
                            }
                        }
